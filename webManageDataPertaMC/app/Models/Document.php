...
class Document extends Model
{
    ...
    // Get the first request through tools
    public function request()
    {
        return $this->hasOneThrough(Request::class, Tool::class, 'no_document', 'tool_id', 'no_request', 'idTools');
    }
    ...
    // Get tahapan progress percentage based on completed tahapans
    public function getProgressPercentage()
    {
        $totalTahapans = 4; // Total possible tahapans
        $completedTahapans = $this->tahapans()->whereNotNull('Date_Tahapan')->count();
        
        return (int) (($completedTahapans / $totalTahapans) * 100);
    }
