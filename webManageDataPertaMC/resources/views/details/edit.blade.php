                        ...
                        <div class="mb-8">
                            <div class="flex items-center justify-center">
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-2 text-sm font-medium text-green-600">Informasi Dasar</span>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-2 text-sm font-medium text-blue-600">Detail Spesifikasi</span>
                                </div>
                            </div>
                        </div>
                    @endif
                    ...
                    <form action="{{ route('sections.details.update', [$project, $section, $detail]) }}" method="POST" class="space-y-6">
                        ...
                        @else
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg mb-6">
                                <h3 class="font-medium text-gray-700 mb-2">Informasi Dasar</h3>
                                <p><strong>Nama Detail:</strong> {{ $detail->nama_detail }}</p>
                                @if($detail->parent)
                        ...
                        @if($detail->harga_total > 0)
                            <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                                <h4 class="font-medium text-green-800 mb-2">💰 Harga Total Saat Ini</h4>
