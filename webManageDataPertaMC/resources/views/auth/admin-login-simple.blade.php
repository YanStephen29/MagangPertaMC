...
<html lang="en">
<head>
    <meta char        .glass-card {
            background: linear-gradient(145deg, rgba(255, 255, 255, 0.35) 0%, rgba(255, 255, 255, 0.18) 50%, rgba(255, 255, 255, 0.25) 100%);
            backdrop-filter: blur(25px) saturate(1.2);
            border: 2px solid;
            border-image: linear-gradient(145deg, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.4)) 1;
            box-shadow: 
        ...
        .glass-card:hover {
            ...
            box-shadow: 
                0 40px 80px rgba(220, 38, 38, 0.20),
                0 25px 50px rgba(0, 0, 0, 0.25),
                0 15px 30px rgba(185, 28, 28, 0.15),
                inset 0 3px 0 rgba(255, 255, 255, 0.6),
                inset 0 -3px 0 rgba(220, 38, 38, 0.15);
        }
        ...
        /* Professional ambient glow effect */
        .glass-card {
            position: relative;
        }
        ...
        .professional-glass-enhancement {
